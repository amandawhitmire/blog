...
BOOM!! We have a list of eachvolume of the Proceedings with the year and the URL for each. This is the first step - DONE. Looking at this table, yes, the first instance of each volume is kept. 
