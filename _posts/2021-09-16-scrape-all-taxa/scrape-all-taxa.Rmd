...
listcsv <- list.files("/Users/thalassa/Rcode/blog/data/gnfinder-parts-clean",
...
for (k in 1:length(listcsv)){
  ...
  myfile <- outlist[[k]]
  # write_lines(dat[[2]], myfile) # Verbatim name
  write_lines(dat[[3]], myfile) # Clean name
}
...
listfile <- as_tibble(list.files("/Users/thalassa/Rcode/blog/data/taxa-clean-txt",
                       pattern = ".txt", full.names = T, recursive = FALSE))
...
`^[[:punct:]]` finds punctuation at the start of the line.
`[[:punct:]]$` finds punctuation at the end of a line.
